...
const Modal = ({ isOpen, onClose, title, children, footer }) => {
  ...
  return (
    <div className={`scaleIn fixed inset-0 m-auto flex items-center justify-center w-full bg-black bg-opacity-50 z-50`}>
      <div className="bg-slate-900 text-white p-4 m-auto rounded shadow-lg w-auto transition-all z-50 xsm:max-[400px]:w-[350px] xsm:max-[400px]:mx-auto xsm:max-md:w-3/5 xsm:max-lg:max-w-2/5 xsm:max-2xl:max-w-2/5">
